...
public class lab07
{
    ...
    static double calculate(CalculateDoubleArguments calc, double v1, double v2){
        return calc.calculate(v1, v2);
    }
    static double calculate(CalculateOneArgument calc, double v1){
        return calc.calculate(v1);
    }
